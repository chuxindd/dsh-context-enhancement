...
import { assertToolGroupCommitStable, contentDigest, finishToolGroupAudit, openToolGroupAudit, recoverableOpenAuditFor, shouldAttemptToolGroupSummary, toolGroupFingerprint } from "./internal/compaction/tool-group-audit.js";
...
import { partitionSurfaceZones, planForgetBatch, selectForgetBatch } from "./internal/compaction/zones.js";
...
export class BasicCompactionEngine extends CompactionEngine {
    ...
    async summarizeToolGroups(agent, target, policy, olderRange, signal, roundReplacements) {
        ...
        for (const group of groups) {
            ...
            if (!shouldAttemptToolGroupSummary(records, fingerprint))
                continue;
