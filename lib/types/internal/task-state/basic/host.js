 ...
 */
export function normalizeCandidate(candidate, context, onQuarantine) {
 ...
 */
export function commitStable(content, schemaVersion, revision, filterVersion, sourceCursor, inherited) {
