...
const balanceCacheBySession = new WeakMap<SessionRead, BalanceCache>()
...
function eventForSeq(session: SessionRead, seq: SessionSeq): SessionEvent {
...
function balanceCache(session: SessionRead): BalanceCache {
 ...
 */
export function toolPairingBalancedBefore(session: SessionRead, seq: SessionSeq): boolean {
 ...
 * matching log event, or a tool result has no preceding open call.
 */
export function toolPairingBalancedAfter(session: SessionRead, seq: SessionSeq): boolean {
