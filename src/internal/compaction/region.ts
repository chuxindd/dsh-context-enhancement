...
import { isIsolatedOldSummaryRange } from './selection-guard.ts'
...
interface RetainedTailSplit {
  ...
  readonly olderRange: { start: SessionSeq; end: SessionSeq } | null
