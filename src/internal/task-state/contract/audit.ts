...
import { taskStateInheritedPrefixSchema } from './spec.ts'
import type {
 ...
 */
export type TaskStateAuditClassification =
  | 'committed'
  | 'terminal-infeasible'
  | 'transient-failure'
  | 'aborted'
 ...
 */
export function classifyAuditRow(row: TaskStateAuditRecord): TaskStateAuditClassification {
