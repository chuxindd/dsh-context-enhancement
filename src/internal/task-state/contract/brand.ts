 ...
 */
export function TaskStateRequestId(id: string): TaskStateRequestId {
  return id as TaskStateRequestId
}
 ...
 * @returns the same string, branded; no validation is performed.
 */
export function TaskStateEntryId(id: string): TaskStateEntryId {
  return id as TaskStateEntryId
}
