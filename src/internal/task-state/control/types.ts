...
export type TaskStateEditResult =
  | { readonly ok: true; readonly stable: TaskStateStable }
  | { readonly ok: false; readonly code: 'unavailable' | 'not-found' | 'conflict' | 'invalid'; readonly message: string; readonly stable?: TaskStateStable }
...
export type TaskStateControlFrame =
  ...
  | { readonly type: 'update'; readonly value: { readonly sessionId: SessionId; readonly stable: TaskStateStable | null } }
