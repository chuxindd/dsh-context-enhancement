...
export const taskStateDomainSpec = defineDomain({
  ...
  layout: 'single',
  tables: {
    sessions: domainTable<SessionId, TaskStateRecord>(taskStateRecordSchema),
    audit: domainTable<TaskStateRequestId, TaskStateAuditRecord>(taskStateAuditSchema),
  },
})
 ...
 */
export const TASK_STATE_LEGACY_DOMAIN_NAME = 'context_enhancement_task_state' as const

/** The two declared table names, in spec order. */
export const TASK_STATE_SESSIONS_TABLE = 'sessions' as const
export const TASK_STATE_AUDIT_TABLE = 'audit' as const
