 ...
 */
export function sessionInheritedPrefix(session: Session): TaskStateInheritedPrefix | null {
  ...
  return {
    ...
    ...parentSession === undefined ? {} : { parentSession: String(parentSession) },
  }
}
 ...
 */
export function inheritedCursorFloor(prefix: TaskStateInheritedPrefix | null): number {
 ...
 */
export function inheritedCoverageRefused(
  prefix: TaskStateInheritedPrefix | null,
 ...
 */
export function isInheritedSeq(prefix: TaskStateInheritedPrefix | null, seq: number): boolean {
  return prefix !== null && seq < prefix.ownBoundarySeq
}
