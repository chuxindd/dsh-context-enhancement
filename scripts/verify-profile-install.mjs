 ...
 * The tarball defaults to `dsh-context-enhancement-0.1.5.tgz` beside this
...
async function main() {
  const tarball = resolve(process.argv[2] ?? join(repoRoot, 'dsh-context-enhancement-0.1.5.tgz'))
